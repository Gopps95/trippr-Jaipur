...
# big _la
# user info
# Define the function to handle user inputs and generate recommendations
def output_main(Type, Duration, Budget, TYPE, Ques):
    """Function to generate travel recommendations based on user inputs"""
